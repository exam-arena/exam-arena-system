        ...
        <form id="register-form" onSubmit={handleSubmit} className="flex flex-col items-start gap-3 w-full max-w-86">
          ...
          <div className="flex flex-col items-start gap-3 w-full">
            ...
            <div className="flex flex-col items-start gap-1 w-full">
              <label htmlFor="register-fullname" className="text-[#004EDC] text-[16px] font-bold leading-6">
                Họ và tên
              </label>
              <Input
            ...
            {/* Username */}
            <div className="flex flex-col items-start gap-1 w-full">
              <label htmlFor="register-username" className="text-[#004EDC] text-[16px] font-bold leading-6">
                Tên tài khoản
              </label>
              <Input
            ...
            {/* Email */}
            <div className="flex flex-col items-start gap-1 w-full">
              <label htmlFor="register-email" className="text-[#004EDC] text-[16px] font-bold leading-6">
                Email
              </label>
              <Input
                id="register-email"
            ...
            {/* Password */}
            <div className="flex flex-col items-start gap-1 w-full">
              <label htmlFor="register-password" className="text-[#004EDC] text-[16px] font-bold leading-6">
                Mật khẩu
              </label>
              <Input
            ...
            {/* Confirm Password */}
            <div className="flex flex-col items-start gap-1 w-full">
              <label htmlFor="register-confirm-password" className="text-[#004EDC] text-[16px] font-bold leading-6">
                Nhập lại mật khẩu
              </label>
              <Input
