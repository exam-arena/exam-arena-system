...
export function AttemptFullscreenWarningDialog({
  ...
  return (
    <div className="fixed inset-0 z-[120] flex items-center justify-center bg-[#1f2937]/70 px-4 backdrop-blur-sm">
      <div className="w-full max-w-[440px] rounded-[28px] bg-white p-7 text-center shadow-[0px_20px_60px_rgba(15,23,42,0.28)]">
        <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-full bg-[#eaf2ff] text-[2rem] text-[#004edc]">
          !
        </div>

        <h2 className="mt-5 text-[1.9rem] font-bold leading-tight text-[#004edc]">
        ...
        <div className="mt-6 rounded-[22px] border border-[#bfd7ff] bg-[#f6fbff] px-6 py-5">
          <div className="text-xs font-semibold uppercase tracking-[0.18em] text-[#2563eb]">
            Tự động nộp bài sau
          </div>
          <div className="mt-2 text-6xl font-bold leading-none text-[#004edc]">
            {countdown}
          </div>
        ...
        <div className="mt-6 rounded-[20px] border border-[#dbeafe] bg-[#f8fbff] px-5 py-4 text-left">
          <div className="text-sm font-semibold text-[#004edc]">Lưu ý quan trọng</div>
