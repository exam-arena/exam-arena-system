      ...
      <div className="min-w-[500px] w-full max-w-3xl grid grid-cols-[1fr_80px_80px] gap-x-3 gap-y-2 text-mediumslateblue text-base">
        ...
        {statements.map((stmt, idx) => {
          ...
          <React.Fragment key={stmt.id}>
            <div className="flex items-center px-[1.5rem] py-3 bg-aliceblue text-foreground border border-aliceblue transition-colors min-h-[48px] rounded-lg">
              <span className="leading-[1.75rem] w-full break-words">
